// -*- coding: utf-8 -*-
// src/SolidWorks/Documents/SwDocumentDependencies.cs
//*********************************************************************
//xCAD
...
//*********************************************************************
// 说明：
// 本文件实现 SolidWorks 文档依赖关系（Document Dependencies）的封装。
// 文档依赖记录当前文档引用的所有外部文档，如装配体引用的零件、
// 工程图关联的模型等。该类提供依赖文档的访问和缓存管理功能。
//*********************************************************************
