// -*- coding: utf-8 -*-
// src/SolidWorks/Documents/SwDrawing.cs
//*********************************************************************
//xCAD
...
//*********************************************************************
// 说明：
// 本文件实现 SolidWorks 工程图（Drawing）文档的封装。
// 工程图文档是 SOLIDWORKS 中用于生成二维工程图纸的文档类型。
//
// 工程图核心功能：
// 1. 图纸管理（Sheet）- 管理图纸大小、比例、格式等
// 2. 视图管理（View）- 添加标准视图、剖视图、详图视图等
// 3. 尺寸和注解 - 自动生成和手动添加尺寸、公差、符号等
// 4. 详图选项 - 控制装饰螺纹、中心线、截面线等的显示
//
// 工程图文档结构：
// - DrawingDoc 是顶级接口，对应整个工程图文档
// - Sheet 代表每张图纸（一张工程图可以有多个图纸）
// - View 代表图纸上的每个视图
//*********************************************************************
