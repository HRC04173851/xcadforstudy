// -*- coding: utf-8 -*-
// src/SolidWorks/Geometry/ISwRegion.cs
//*********************************************************************
//xCAD
...
//*********************************************************************
// 说明：
// 本文件实现 SolidWorks 区域（Region）的封装。
// 区域是由闭合边界曲线组成的面域，通常包含外边界和可选的内边界（孔）。
// 提供了 ISwRegion 和 ISwPlanarRegion 接口，支持平面区域的创建和操作。
// 用于拉伸、旋转等特征的定义，以及曲面片体的构造。
//*********************************************************************
