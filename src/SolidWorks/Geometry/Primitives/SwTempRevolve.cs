// -*- coding: utf-8 -*-
// src/SolidWorks/Geometry/Primitives/SwTempRevolve.cs
//*********************************************************************
//xCAD
...
//*********************************************************************
// 说明：
// 本文件实现 SolidWorks 临时旋转基元（Temp Revolve）的创建功能。
// 旋转是将二维轮廓绕指定轴线旋转生成三维实体的操作。
// 需要指定旋转轴（直线）、旋转角度和截面轮廓。
// 常用于创建回转体零件，如轴、轮毂、瓶体等对称几何形状。
//*********************************************************************
