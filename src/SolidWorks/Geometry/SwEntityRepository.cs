// -*- coding: utf-8 -*-
// src/SolidWorks/Geometry/SwEntityRepository.cs
//*********************************************************************
//xCAD
...
//*********************************************************************
// 说明：
// 本文件实现 SolidWorks 实体仓库（Entity Repository）的封装。
// 实体仓库提供几何体拓扑元素（Face、Edge、Vertex）的枚举和查询功能。
// 支持按类型过滤、名称查找等操作，用于遍历和管理几何体的拓扑结构。
//*********************************************************************
