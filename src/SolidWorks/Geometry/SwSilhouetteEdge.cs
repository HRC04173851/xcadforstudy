// -*- coding: utf-8 -*-
// src/SolidWorks/Geometry/SwSilhouetteEdge.cs
//*********************************************************************
//xCAD
...
//*********************************************************************
// 说明：
// 本文件实现 SolidWorks 轮廓边（Silhouette Edge）的封装。
// 轮廓边是模型在特定视角下可见性发生变化的边界线。
// 通常出现在曲面的最大曲率处，是渲染和可视化中的重要元素。
// 支持获取轮廓边关联的 Face 和曲线定义。
//*********************************************************************
