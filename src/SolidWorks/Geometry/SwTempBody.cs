// -*- coding: utf-8 -*-
// src/SolidWorks/Geometry/SwTempBody.cs
//*********************************************************************
//xCAD
...
//*********************************************************************
// 说明：
// 本文件实现 SolidWorks 临时几何体（Temp Body）的封装。
// 临时几何体是在内存中构造的 Body，支持添加、减去、求交等布尔操作。
// 提供预览功能，可在提交前以不同颜色显示几何体。
// 是内存几何体构造的核心对象，提交后成为永久几何体。
//*********************************************************************
