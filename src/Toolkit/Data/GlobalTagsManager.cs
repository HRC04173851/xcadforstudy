// -*- coding: utf-8 -*-
// src/Toolkit/Data/GlobalTagsManager.cs
//*********************************************************************
//xCAD
...
//*********************************************************************
// 说明：
// 本文件实现全局标签管理服务 GlobalTagsManager 和 GlobalTagsRegistry。
// 通过全局注册表管理对象标签，适用于实例与底层原生对象语义不一致的场景。
// 支持标签的添加、获取、弹出和删除，自动跟踪文档生命周期。
//*********************************************************************
