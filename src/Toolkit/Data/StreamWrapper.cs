// -*- coding: utf-8 -*-
// src/Toolkit/Data/StreamWrapper.cs
//*********************************************************************
//xCAD
...
//*********************************************************************
// 说明：
// 本文件实现托管 Stream 到 COM IStream 的适配器类 StreamWrapper。
// 将 .NET Stream 封装为 COM 可调用的 IStream 接口，实现跨边界数据流传递。
// 支持基本的读写、定位和提交操作，部分方法标记为不支持。
//*********************************************************************
